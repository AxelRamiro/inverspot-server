      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="min-width: 320px;">
          ...
          <table border="0" cellspacing="0" cellpadding="0" class="table_width_100" width="100%" style="max-width: 680px; min-width: 300px;">
              ...
              <tr><td align="center" bgcolor="#fbfcfd">
                  ...
                  <table width="90%" border="0" cellspacing="0" cellpadding="0" style="">
                      <tr>
                          ...
                          <td align="left">
                              <div style="line-height: 24px;">
                                              <br><font face="AvenirNext-Bold" size="3" color="#000" style="font-size: 26px;">
              ...
              <tr><td class="iage_footer" align="center" bgcolor="#ffffff">
                  ...
                  <table width="90%" border="0" cellspacing="0" cellpadding="0" style="background-color: rgb(216, 216, 216);">
                      <tr>
                         <td align="center">
                          <div style="line-height: 24px;">
              ...
              <!--footer -->
              <tr><td class="iage_footer" align="center" bgcolor="#4b118e">
                  <!-- padding --><div style="height: 40px; line-height: 80px; font-size: 10px;"> </div>
