      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" style="min-width: 320px;">
          ...
          <table border="0" cellspacing="0" cellpadding="0" class="table_width_100" width="100%" style="max-width: 680px; min-width: 300px;">
              ...
              <tr><td align="center" bgcolor="#fbfcfd">
                  ...
                  <table width="90%" border="0" cellspacing="0" cellpadding="0" style="margin-left:65px;">
                      <tr>
                          <td align="left">
                          ...
                          <td align="left">
                              <div style="line-height: 24px;">
                                              <font face="AvenirNext-Bold" size="3" color="#000" style="font-size: 22px;">
                                              <strong style="font-family: AvenirNext-Bold; font-size: 22px; color: black;">
                                                  <a style="color: black;">Proyecto: </a>
                                              </strong></font>
                      ...
                      <tr>
                          ...
                          <td align="left">
                              <div style="line-height: 24px;">
                                              <font face="AvenirNext-Bold" size="3" color="#000" style="font-size: 22px;">
                                              <strong style="font-family: AvenirNext-Bold; font-size: 22px; color: black;">
                                                  <a style="color: black;">Participaciones: </a>
                                              </strong></font>

                                              <font face="AvenirNext-Regular" size="4" color="#000" style="font-size: 22px;">
                                              <span style="font-family: AvenirNext-Regular; font-size: 22px; color: black;">
                                                  <b>${params.sharesNumber}</b>
                                              </span></font>
                              </div>
                          </td>
                      </tr>
                      <tr>
                          <td align="left">
                              <div style="line-height: 24px;">
                                              <font face="AvenirNext-Bold" size="3" color="#000" style="font-size: 22px;">
                                              <strong style="font-family: AvenirNext-Bold; font-size: 22px; color: black;">
                                                  <a style="color: black;">Teléfono: </a>
                                              </strong></font>
              ...
              <!--footer END-->
              <tr><td>
              <!-- padding --><div style="height: 135px;"> </div>
              </td></tr>
          </table>
